...
//    protected float[][] points = new float[][]{{1, 10}, {2, 47}, {3, 11}, {4, 38}, {5, 50}, {6, 52}, {7, 44}, {8, 37}, {9, 29}, {10, 31}};
    protected float[][] points = new float[][]{{1, 10}, {2, 46}, {3, 11}, {4, 38}, {5, 50}, {6, 52}, {7, 44}, {8, 37}, {9, 29}, {10, 31}};
